...
public class VNPayService {
    ...
    public String createPaymentUrlWithTxnRef(CreatePaymentRequest request, String ipAddress, String txnRef) {
        return createPaymentUrlWithTxnRef(request, ipAddress, txnRef, config.getReturnUrl());
    }
    
    public String createPaymentUrlWithTxnRef(CreatePaymentRequest request, String ipAddress, String txnRef, String returnUrl) {
        ...
        for (String name : fieldNames) {
            ...
            if (value != null && value.length() > 0) {
                ...
                hashData.append(name).append("=").append(encodedValue).append("&");
                query.append(name).append("=").append(encodedValue).append("&");
            }
        }
        // Remove trailing &
