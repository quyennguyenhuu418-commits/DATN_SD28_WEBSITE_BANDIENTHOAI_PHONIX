...
public class SanPhamController {
    ...
    @GetMapping("/chi-tiet/{id}/images")
    public ResponseEntity<List<HinhAnh>> getImagesByChiTietId(@PathVariable Integer id) {
        try {
            List<HinhAnh> images = sanPhamService.getImagesByChiTietId(id);
