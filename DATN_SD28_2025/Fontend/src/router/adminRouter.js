...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/nhan-vien/chi-tiet/:id', name: 'nhan-vien-detail', component: ChiTietNhanVienPage, meta: { requiresAuth: true } },
    ...
    { path: '/admin/forgot-password', name: 'admin-forgot-password', component: ForgotPasswordPage, meta: { requiresAuth: false } },
    ...
    // Payment return pages for Admin (POS)
    {
      path: '/payment/vnpay-return',
      name: 'admin-vnpay-return',
      component: () => import('../views/PaymentResultPage.vue'),
      meta: { requiresAuth: true, role: 'STAFF' }
    },
    {
      path: '/payment/zalopay-return',
      name: 'admin-zalopay-return',
      component: () => import('../views/ZaloPayResultPage.vue'),
      meta: { requiresAuth: true, role: 'STAFF' }
    },
