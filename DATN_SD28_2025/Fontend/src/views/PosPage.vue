<template>
  <div class="h-screen flex flex-col bg-slate-100">
    ...
    <div class="flex-1 flex overflow-hidden">
      ...
      <aside class="w-96 bg-white shadow-lg flex flex-col border-l border-slate-200">
        <!-- Payment Header -->
          ...
          <div class="space-y-3">
            <div class="flex items-center space-x-4">
              <label class="flex items-center space-x-2">
                <input type="radio" name="paymentMethod" value="cash" checked class="text-orange-600">
                <span class="text-sm">Tiền mặt</span>
              </label>
              <label class="flex items-center space-x-2">
                <input type="radio" name="paymentMethod" value="transfer" class="text-orange-600">
                <span class="text-sm">Chuyển khoản</span>
              </label>
              <label class="flex items-center space-x-2">
                <input type="radio" name="paymentMethod" value="card" class="text-orange-600">
                <span class="text-sm">Thẻ</span>
              </label>
              <label class="flex items-center space-x-2">
                <input type="radio" name="paymentMethod" value="vi" class="text-orange-600">
                <span class="text-sm">Ví</span>
              </label>
            </div>
          </div>
  ...
  setup() {
    ...
    const normalSale = async () => {
      ...
      try {
        ...
        await api.post('/api/hoa-don/pos-order', orderData)
